...
//------------------------------------------------------------------------------
Stub_module::Stub_module // Constructor
...
, m_targ_peq                { "targ_peq", this, &Stub_module::targ_peq_cb }
{
  ...
  SC_METHOD( execute_transaction_process );
    ...
    dont_initialize();
  targ_socket.register_b_transport        ( this, &Stub_module::b_transport );
  targ_socket.register_nb_transport_fw    ( this, &Stub_module::nb_transport_fw );
  targ_socket.register_get_direct_mem_ptr ( this, &Stub_module::get_direct_mem_ptr );
  targ_socket.register_transport_dbg      ( this, &Stub_module::transport_dbg );
...
//------------------------------------------------------------------------------
void
Stub_module::b_transport
( Stub_module::tlm_payload_t& trans
, sc_time& delay
)
{
...
bool Stub_module::configure( tlm_payload_t& trans )
{
...
//------------------------------------------------------------------------------
void Stub_module::execute_transaction( Stub_module::tlm_payload_t& trans )
{
  Depth_t len = trans.get_data_length();
...
//------------------------------------------------------------------------------
void
Stub_module::targ_peq_cb
( Stub_module::tlm_payload_t& trans
, const Stub_module::tlm_phase_t& phase
)
{
  sc_time delay;
...
//------------------------------------------------------------------------------
void
Stub_module::send_end_req( Stub_module::tlm_payload_t& trans )
{
  Stub_module::tlm_phase_t bw_phase;
  sc_time delay;
...
//------------------------------------------------------------------------------
void
Stub_module::send_response( Stub_module::tlm_payload_t& trans )
{
...
void
Stub_module::execute_transaction_process( void )
{
...
//------------------------------------------------------------------------------
bool Stub_module::payload_is_ok( Stub_module::tlm_payload_t& trans, Depth_t len, Style coding_style )
{
