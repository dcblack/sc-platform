...
add_custom_target(run
   env ${shared_env} ./${TARGET_EXECUTABLE} $(ARGS) 2>&1 | filter-sclog | tee run.log
   DEPENDS ${TARGET_EXECUTABLE}
   COMMENT "Running program"
   USES_TERMINAL
   )
add_custom_target(debug
   env DEBUG=1 ${shared_env} ./${TARGET_EXECUTABLE} -debug -error-at-target $(ARGS) 2>&1 | filter-sclog | tee run.log
   DEPENDS ${TARGET_EXECUTABLE}
   COMMENT "Debugging program"
   USES_TERMINAL
   )
add_custom_target(gdb
   env DEBUG=1 ${shared_env} gdb ./${TARGET_EXECUTABLE} -- -debug -error-at-target $(ARGS) 2>&1 | filter-sclog | tee run.log
   DEPENDS ${TARGET_EXECUTABLE}
   COMMENT "Debugging program"
   USES_TERMINAL
   )
